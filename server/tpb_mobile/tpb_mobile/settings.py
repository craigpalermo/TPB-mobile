# Django settings for tpb_mobile project.
import os
from tpb_mobile.environments import development as current_environment
...
SECRET_KEY = 's=bmue_mc--@c^rq5upi%nq@50t9564g0es_*miwuwfcp4x0!a'
...
WSGI_APPLICATION = 'tpb_mobile.wsgi.application'
